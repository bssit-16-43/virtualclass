...
const server_url = process.env.NODE_ENV === 'production' ? 'https://vuclassroom.herokuapp.com' : "http://localhost:4001"
					...
					<div>
						...
						<div className="container">
							...
							<Row id="main" className="flex-container" style={{ margin: 0, padding: 0 }}>
								<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
									borderStyle: "solid",borderColor: "#009bff",margin: "10px",objectFit: "fill",
									width: "100%",height: "100%", borderRadius:"10px"}}></video>
							</Row>
						</div>
					</div>
				}
