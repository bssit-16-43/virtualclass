...
const server_url = process.env.NODE_ENV === 'production' ? 'https://gpgcsclassroom.herokuapp.com' : "http://localhost:4001"
				...
				{this.state.askForUsername === true ?
					<div>
						<div style={{
							...
							<p style={{ margin: 0, fontWeight: "bold", }}>SET YOUR NICK NAME HERE.</p>
						...
						<div style={{ justifyContent: "center", textAlign: "center", paddingTop: "40px" }}>
							<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
								...
								borderColor: "#22c0c3", objectFit: "fill", width: "60%", height: "30%" ,borderRadius:"20px"
							}}></video>
						</div>
					</div>
					:
					<div>
						...
						<div className="container">
							...
							<Row id="main" className="flex-container" style={{ margin: 0, padding: 0 }}>
								<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
									borderStyle: "solid", borderColor: "#22c0c3", margin: "10px", objectFit: "fill",
									transform: "rotateY(180deg)", width: "100%", height: "100%" , borderRadius:"15px"
								}}></video>
							</Row>
						</div>
					</div>
